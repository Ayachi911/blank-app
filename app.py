...
def extract_text_from_pdf(pdf_file):
    ...
    Args:
        pdf_file: UploadedFile object from Streamlit (or file path).
    Returns:
        str: Extracted text.
    """
...
def extract_text_from_docx(docx_file):
    ...
    Args:
        docx_file: UploadedFile object from Streamlit (or file path).
    Returns:
        str: Extracted text.
    """
...
def clean_text(text):
    """
    Cleans the input text by lowercasing, removing non-alphabetic characters,
...
def calculate_skill_match(resume_text, job_description_text):
    """
    Calculates the skill match score and identifies missing skills.
    Args:
        resume_text (str): Cleaned text from the resume.
        job_description_text (str): Cleaned text from the job description.
    Returns:
        tuple: (match_score (float), missing_skills (list of str))
    """
